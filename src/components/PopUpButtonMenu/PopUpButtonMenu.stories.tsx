...
import { faEllipsisH, faEdit, faTrash, faCopy } from '@fortawesome/free-solid-svg-icons';
...
export const Default: Story = {
    args: {
        ...
        items: [
            { id: 'edit', label: 'Edit', icon: faEdit, onClick: () => console.log('Edit') },
            { id: 'copy', label: 'Copy', icon: faCopy, onClick: () => console.log('Copy') },
            { id: 'sep1', label: '', type: 'separator', onClick: () => { } },
            { id: 'delete', label: 'Delete', icon: faTrash, variant: 'destructive', onClick: () => console.log('Delete') },
        ],
        align: 'left',
    },
};
